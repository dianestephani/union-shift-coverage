...
class ShiftResponse(models.Model):
    ...
    class Answer(models.TextChoices):
        ...
        # UNSURE that was later resolved
        UNSURE_YES = "UNSURE_YES", "Unsure → Yes"
        UNSURE_NO = "UNSURE_NO", "Unsure → No"
...
class CoverageEvent(models.Model):
    ...
    class EventType(models.TextChoices):
        ...
        UNSURE_RESOLVED = "UNSURE_RESOLVED", "UNSURE response resolved"
